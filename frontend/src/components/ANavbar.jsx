...
const ANavbar = () => {
  ...
  const navLinks = [
    { name: 'Dashboard', icon: <DashboardOutlined />, id: 'dashboard', path: '/alumnihome' },
    { name: 'My Mentees', icon: <GroupOutlined />, id: 'mymentees', path: '/mymentees' },
    { name: 'Requests', icon: <QuestionAnswerOutlined />, path: '/menteerequests' },
    { name: 'Careers', icon: <WorkOutlined />, id: 'careers', path: '/alumnijobs' },
    { name: 'Events', icon: <EventOutlined />, id: 'events', path: '/events' },
  ];
      ...
      >
        <Container maxWidth="xl" sx={{ px: { xs: 1, sm: 2, md: 3 } }}>
          <Toolbar sx={{ justifyContent: 'space-between', px: { xs: 0, sm: 1 }, minHeight: { xs: 56, sm: 64 } }}>
            ...
            >
              <MenuItem onClick={() => { handleCloseUserMenu(); navigate("/aprofile"); }}>
        ...
        <Box sx={{ p: 2 }}>
          ...
          <Box sx={{ px: 1 }}>
            ...
            <Stack spacing={0.5} sx={{ mt: 1.5 }}>
              <Button fullWidth startIcon={<Person fontSize="small" />} onClick={() => { handleMobileMenuClose(); navigate("/aprofile"); }} sx={{ color: deepZinc, fontWeight: 600, justifyContent: 'flex-start', px: 2, py: 1, textTransform: 'none' }}>Profile</Button>
